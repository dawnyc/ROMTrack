...
class VOTDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        anno_path = '{}/annotations/{}/groundtruth.txt'.format(self.base_path, sequence_name)
        ...
        if self.year == 18 or self.year == 22:
            ...
            frames = ['{base_path}/data/{sequence_path}/{frame:0{nz}}.{ext}'.format(base_path=self.base_path,
...
def parse(string):
    ...
    """
    # from vot.region.shapes import Rectangle, Polygon, Mas
    if string[0] == 'm':
